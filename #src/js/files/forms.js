...
function select_item(select) {
  ...
  if (select_type == 'input') {
    ...
    const select_option_discount = select_selected_option.dataset.discount
      ? `<small class="_success-b">${select_selected_option.dataset.discount}</small>`
      : '';
  ...
  if (select_options) {
    ...
    for (let index = 0; index < select_options.length; index++) {
      ...
      if (select_option_value != '' && !select_option_image) {
        const select_option_text = select_option.innerHTML;
        const select_option_discount = select_option.dataset.discount ? `<small class="_success-b">${select_option.dataset.discount}</small>` : '';
